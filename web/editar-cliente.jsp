            ...
            <div class="row">
                <div class="row">
                    <div class="border-titulo text-center">
                        ...
                        <input type="button" class="btn btn-primary" value="Salvar" id="salvarCliente">
                        <input type="button" class="btn btn-primary" value="Editar" id="editarCliente">
                        <input type="button" class="btn btn-danger"  value="Voltar" id="cancelarEditCliente">
                        <div class="clearfix"></div>
                    </div>
                </div>
            </div>
