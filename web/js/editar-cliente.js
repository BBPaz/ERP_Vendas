$(function(){
    ...
    $("#cancelarEditCliente").on("click",function(){
        if(prompt("Cancelar edição de cliente?"))
    ...
    function alterarCliente(){
        $.ajax({
            ...
            type:"get",
            data:"op=alterarCliente&idCliente="+idCliente+"&tipo="+tipo+"&nomeCliente="+$("#nomeCliente").val()+"&cpfCliente="+$("#cpfCliente").val()+"&dataNascCliente="+$("#dataNascCliente").val()+"&razaoSocialCliente="+$("#razaoSocialCliente").val()+"&cnpjCliente="+$("#cnpjCliente").val()+"&inscMunicCliente="+$("#inscMunicCliente").val()+"&inscEstCliente="+$("#inscEstCliente").val()+"&emailCliente="+$("#emailCliente").val()+"&numeroCliente="+$("#numeroCliente").val()+"&log="+$("#log").val()+"&numeroEndereco="+$("#numeroEndereco").val()+"&complemento="+$("#complemento").val()+"&bairro="+$("#bairro").val()+"&cidade="+$("#cidade").val()+"&cep="+$("#cep").val()+"&estado="+$("#estado").val(),
            success: function(data){
                alert("Salvo");
                //window.location.replace("/ERP_Panelas/venda.jsp"/*ERP_Panelas/verificar-cliente-venda.jsp?idCliente="+idCliente*/);
            },
